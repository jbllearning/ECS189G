...
from code.stage_2_code2.Method_MLP_change import Method_MLP
...
if 1:
    ...
    data_obj = Dataset_Loader('training set data', '')
    ...
    evaluate_obj = Evaluate_Metrics('accuracy precision recall f1', '')
    # ------------------------------------------------------
