...
def run_GCN_train_eval(dataset, dropout=0.5, epochs=200, eval_interval=10, lr=0.01, weight_decay=5e-4):
    ...
    # Save result
    result_path = os.path.join(PROJECT_ROOT, "result", "stage_5_result", f"{dataset}_result_ablation.txt")
    ...
    # convergence plot
    plot_path = os.path.join(PROJECT_ROOT, "script", "stage_5_script", f"{dataset}_ablation_training_plot.png")
